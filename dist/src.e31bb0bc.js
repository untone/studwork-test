...
},{"./noConflict":"../node_modules/@babel/polyfill/lib/noConflict.js","core-js/library/fn/global":"../node_modules/core-js/library/fn/global.js"}],"../node_modules/idempotent-babel-polyfill/lib/index.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
},{"@babel/polyfill":"../node_modules/@babel/polyfill/lib/index.js"}],"../node_modules/vue/dist/vue.runtime.esm.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
},{}],"components/starships.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  name: 'Starships',
  computed: _objectSpread({}, (0, _vuex.mapGetters)('starships', ['list', 'loading', 'total']), {
  ...
  methods: _objectSpread({}, (0, _vuex.mapActions)('starships', ['fetchStarships']), {}, (0, _vuex.mapMutations)('starships', ['setPage']), {
    getId: function getId(url) {
      return url.match(/(\d*)\/$/)[1];
    },
    getStarships: function getStarships() {
...
exports.default = _default;
        var $ee1417 = exports.default || module.exports;
      
      if (typeof $ee1417 === 'function') {
        $ee1417 = $ee1417.options;
      }
    
        /* template */
        Object.assign($ee1417, (function () {
          var render = function() {
  var _vm = this
      ...
      _vm.pager
        ? _c("footer", [
            ...
            _c(
              "button",
              {
                attrs: { disabled: _vm.page * 10 > _vm.total },
                on: {
                  click: function($event) {
                    return _vm.onPage("next")
                  }
                }
              },
              [_vm._v("\n      Next\n    ")]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ee1417', $ee1417);
          } else {
            api.reload('$ee1417', $ee1417);
          }
        }
...
var _default = {
  name: 'Starship',
  computed: _objectSpread({}, (0, _vuex.mapGetters)('starship', ['item', 'loading'])),
  created: function created() {
    this.fetchStarship(this.$route.params);
  },
  methods: _objectSpread({}, (0, _vuex.mapActions)('starship', ['fetchStarship']))
};
exports.default = _default;
        var $799354 = exports.default || module.exports;
      
      if (typeof $799354 === 'function') {
        $799354 = $799354.options;
      }
    
        /* template */
        Object.assign($799354, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$799354', $799354);
          } else {
            api.reload('$799354', $799354);
          }
        }
...
var _starship = _interopRequireDefault(require("./components/starship"));
...
var routes = [{
  ...
  path: '/starship/:id',
  name: 'starship',
  component: _starship.default
}];
var _default = routes;
exports.default = _default;
},{"./components/starships":"components/starships.vue","./components/starship":"components/starship.vue"}],"api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getStarship = exports.getStarships = void 0;
...
var searchParams = function searchParams(params) {
...
function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            endpoint = '/starships/';
            return _context.abrupt("return", fetchData(endpoint, params));
  ...
  return function getStarships(_x) {
...
function () {
  ...
  return function getStarship(_x2) {
    return _ref3.apply(this, arguments);
  };
}();

exports.getStarship = getStarship;
},{}],"store/modules/starships.js":[function(require,module,exports) {
"use strict";
...
var starships = {
  ...
  actions: {
    fetchStarships: function () {
      var _fetchStarships = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 7;
                return (0, _api.getStarships)(payload);
...
},{"../../api":"api.js"}],"store/modules/starship.js":[function(require,module,exports) {
"use strict";
...
var starship = {
  ...
  actions: {
    fetchStarship: function () {
      var _fetchStarship = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return (0, _api.getStarship)(payload);
      ...
      function fetchStarship(_x, _x2) {
        return _fetchStarship.apply(this, arguments);
      }
...
},{"../../api":"api.js"}],"store/index.js":[function(require,module,exports) {
"use strict";
...
var _starships = require("./modules/starships");

var _starship = require("./modules/starship");
...
var _default = new _vuex.default.Store({
  modules: {
    starships: _objectSpread({
      namespaced: true
    }, _starships.starships),
    starship: _objectSpread({
      namespaced: true
    }, _starship.starship),
    errors: []
  }
...
exports.default = _default;
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","vuex":"../node_modules/vuex/dist/vuex.esm.js","./modules/starships":"store/modules/starships.js","./modules/starship":"store/modules/starship.js"}],"app.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $7dc6d3 = exports.default || module.exports;
      
      if (typeof $7dc6d3 === 'function') {
        $7dc6d3 = $7dc6d3.options;
      }
    
        /* template */
        Object.assign($7dc6d3, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$7dc6d3', $7dc6d3);
          } else {
            api.reload('$7dc6d3', $7dc6d3);
          }
        }
...
_vue.default.config.devtools = "development" === 'development';
new _vue.default({
  el: '#app',
  router: router,
...
},{"idempotent-babel-polyfill":"../node_modules/idempotent-babel-polyfill/lib/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js","vue-router":"../node_modules/vue-router/dist/vue-router.esm.js","./routes":"routes.js","./store":"store/index.js","./app.vue":"app.vue"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
